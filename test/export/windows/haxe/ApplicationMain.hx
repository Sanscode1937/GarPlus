...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TextureAtlas", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TextureAtlas", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TextureAtlas";
		app.meta["name"] = "TextureAtlas 2018 Test(Tankman Test)";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "TextureAtlas 2018 Test(Tankman Test)",
			width: 1280,
			x: null,
			y: null,
		};
