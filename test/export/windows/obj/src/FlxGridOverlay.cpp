...
HX_LOCAL_STACK_FRAME(_hx_pos_ac2c47d06dc49292_36_create,"FlxGridOverlay","create",0x0d39a272,"FlxGridOverlay.create","FlxGridOverlay.hx",36,0x095e2386)
HX_LOCAL_STACK_FRAME(_hx_pos_ac2c47d06dc49292_81_overlay,"FlxGridOverlay","overlay",0x1cda0f5a,"FlxGridOverlay.overlay","FlxGridOverlay.hx",81,0x095e2386)
HX_LOCAL_STACK_FRAME(_hx_pos_ac2c47d06dc49292_103_createGrid,"FlxGridOverlay","createGrid",0x5aa5c658,"FlxGridOverlay.createGrid","FlxGridOverlay.hx",103,0x095e2386)
...
bool FlxGridOverlay_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0e33d4f8;
}
 ...
 ::flixel::FlxSprite FlxGridOverlay_obj::create(int CellWidth,int CellHeight,::hx::Null< int >  __o_Width,::hx::Null< int >  __o_Height,::hx::Null< bool >  __o_Alternate,::hx::Null< int >  __o_Color1,::hx::Null< int >  __o_Color2){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ac2c47d06dc49292_36_create)
...
HXLINE(  52)		 ::openfl::display::BitmapData grid = ::FlxGridOverlay_obj::createGrid(CellWidth,CellHeight,Width,Height,Alternate,Color1,Color2);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC7(FlxGridOverlay_obj,create,return )
 ...
 ::flixel::FlxSprite FlxGridOverlay_obj::overlay( ::flixel::FlxSprite Sprite,int CellWidth,int CellHeight,::hx::Null< int >  __o_Width,::hx::Null< int >  __o_Height,::hx::Null< bool >  __o_Alternate,::hx::Null< int >  __o_Color1,::hx::Null< int >  __o_Color2){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ac2c47d06dc49292_81_overlay)
...
HXLINE(  97)		 ::openfl::display::BitmapData grid = ::FlxGridOverlay_obj::createGrid(CellWidth,CellHeight,Width,Height,Alternate,Color1,Color2);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC8(FlxGridOverlay_obj,overlay,return )
 ...
 ::openfl::display::BitmapData FlxGridOverlay_obj::createGrid(int CellWidth,int CellHeight,int Width,int Height,bool Alternate,int Color1,int Color2){
            	HX_GC_STACKFRAME(&_hx_pos_ac2c47d06dc49292_103_createGrid)
...
void FlxGridOverlay_obj::__register()
{
	...
	__mClass->mName = HX_("FlxGridOverlay",38,52,48,2c);
